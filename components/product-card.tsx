...
export default function ProductCard({ product, isWishlisted, onAddToCart, onToggleWishlist }: ProductCardProps) {
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          >
            {showAddedMessage ? "Added!" : showIncreasedMessage ? "Quantity +1" : "Add to Cart"}
          </button>
        </div>
      </div>
    </div>
